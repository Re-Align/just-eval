...
## Pairwise Comparisons without Aspects 
...
just_eval \
    ...
    --first_file example_data/example_generation_1.json \
    --second_file example_data/example_generation_2.json  \
    --output_file example_data/eval_outputs/1-2.pairwise.gpt-3.5-turbo.json 
...
just_eval \
    ...
    --first_file example_data/example_generation_1.json \
    --second_file example_data/example_generation_2.json  \
    --output_file example_data/eval_outputs/1-2.pairwise.gpt-4.json 

just_eval --report_only --mode "pairwise" \
          --output_file "example_data/eval_outputs/1-2.pairwise.gpt-4.json"
```
